...
class ArticleClassTest extends TestCase
{
    public function testConstructor():void{
        $arg = new Article(new UUID("123e4567-e89b-12d3-a456-426614174000"), new UUID("123e4567-e89b-12d3-a456-426614174001"), "test_title", "test_text");
        $value = (string)$arg;
        $this->assertEquals("id=123e4567-e89b-12d3-a456-426614174000, authorId=123e4567-e89b-12d3-a456-426614174001, title=test_title, text=test_text",trim($value));
    }
