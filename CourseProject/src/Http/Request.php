...
class Request
{
    public function __construct(
        ...
        //  Аргумент, соответствцющий суперглобальной переменной $_SERVER
    ...
    public function method(): string
    {
        ...
        //  HTTP - метод храниться под ключом REQUEST_METHOD
    ...
    //  Например, для http://examle.com/some/page?x=1&y=acb
    ...
    {
        //  В суперглобальном массиве $_SERVER
        //  значение URL храниться под ключем REQUEST_URL
        if (!array_key_exists('REQUEST_URI', $this->server)) {
            //  Если мы не можем получать URI - бросаем исключение
    ...
    {
        //  В суперглобальном массиве $SERVER
